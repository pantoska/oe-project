...
class MainPanel(wx.Panel):
    ...
    def setMinimumValue(self, value, gen):
        self.minimumValueText.SetLabel('Wartość minimalna funkcji: ' + str(value)  + 'generacja ' + str(gen))

    def setMaximumValue(self, value, gen):
        self.minimumValueText.SetLabel('Wartość maksymalna funkcji: ' + str(value) + 'generacja ' + str(gen))
